...
1. В разделе [Releases](https://github.com/nivemoon/micplus/releases) и скачать последний релиз в архиве zip или micplus.exe для обновления старой версии.
2. Извлечь содержимое архива в удобное место, в случае новой установки. Заменить старый micplus.exe на новый, в случае обновления.
