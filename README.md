...
Глобальная система контроля микрофона: **вкл/выкл/рация/звук**.
...
- Правый клик по иконке в трее:
  - выбор PTT-кнопки (MB5 или кастомная клавиша);
  - выбор toggle-хоткея для микрофона (F10 / своё);
  - выбор клавиши для состояния звука (Alt+F9 / своё)
  - включение/выключение PTT-режима; микрофона; звука
